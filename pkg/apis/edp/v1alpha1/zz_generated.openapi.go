...
func schema_pkg_apis_edp_v1alpha1_Sonar(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"sonar-operator/pkg/apis/edp/v1alpha1.SonarSpec", "sonar-operator/pkg/apis/edp/v1alpha1.SonarStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
