...
```
    ...
    - image.name                             # EDP jenkins-oprator Docker image name. The released image can be found on [Dockerhub](https://hub.docker.com/repository/docker/epamedp/sonar-operator);
    - image.version                          # EDP sonar-oprator Docker image tag. The released image can be found on [Dockerhub](https://hub.docker.com/repository/docker/epamedp/sonar-operator/tags);
    ...
    - sonar.imagePullSecrets                 # Secrets to pull from prive Docker registry;
